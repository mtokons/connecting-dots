      ...
      <div className="glass-card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div className="bg-white/[0.03] rounded-xl p-4">
            ...
            <div className="text-slate-400">electionwatchbd.com, election.results.com.bd, election.unb.com.bd, electionresult2026bd.com, votebd.org (SHUJAN), onefiftyonebd.com, EC, Daily Star, Prothom Alo, bdnews24.</div>
          </div>
          <div className="bg-white/[0.03] rounded-xl p-4">
